...
import type { Location, ParamParseKey, Params, Path, PathMatch, PathPattern, RouteMatch, RouteObject, Router as DataRouter, To } from "@remix-run/router";
...
export declare function _renderMatches(matches: RouteMatch[] | null, parentMatches?: RouteMatch[], dataRouterState?: DataRouter["state"] | null): React.ReactElement | null;
/**
 ...
 */
export declare function useRouteLoaderData(routeId: string): any;
/**
