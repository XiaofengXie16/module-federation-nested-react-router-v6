 ...
 * @license MIT
 */
import { invariant, resolveTo, getToPathname, joinPaths, matchPath, warning, parsePath, matchRoutes, createMemoryRouter, createMemoryHistory, Action, normalizePathname, stripBasename } from '@remix-run/router';
...
useSyncExternalStore$3 !== undefined ? useSyncExternalStore$3 : shim;
...
function useRenderDataRouter({
  ...
  return /*#__PURE__*/createElement(DataRouterContext.Provider, {
    ...
    navigator: navigator
  }, /*#__PURE__*/createElement(DataRoutes, {
    routes: routes,
    children: children
  }))));
}
